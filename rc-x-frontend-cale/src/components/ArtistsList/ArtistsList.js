...
function ArtistsList({ fundsListData, balances, hideInspectButton }) {
...
function whatSong(symbol) {
  if (symbol == "ED SHEERAN") {
    return 0;
  } else if (symbol == "QUEEN") {
    return 2;
  } else if (symbol == "LUIS FONSI") {
    return 1;
  } else if (symbol == "MARK RONSON") {
    return 3;
  } else if (symbol == "JUSTIN BIEBER") {
    return 4;
  } else if (symbol == "KATY PERRY") {
    return 5;
  } else if (symbol == "THE WEEKEND") {
    return 6;
  } else if (symbol == "PHARRELL WILLIAMS") {
    return 7;
  } else if (symbol == "PSY") {
    return 8;
  } else if (symbol == "CARLY RAE JEPSEN") {
    return 9;
  } else if (symbol == "ADELE") {
    return 10;
  } else {
    return 1;
  }
